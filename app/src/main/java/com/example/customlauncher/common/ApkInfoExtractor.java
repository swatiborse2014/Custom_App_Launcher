package com.example.customlauncher.common;
...
import com.example.customlauncher.MainActivity;
...
public class ApkInfoExtractor {
    ...
    public String getAppPackageName(String ApkTempPackageName) {
        String s = null;
        s = String.valueOf(context1.getPackageManager().getInstallerPackageName(ApkTempPackageName));
        return s;
    }
